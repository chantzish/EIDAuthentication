/*****************************************************************************
(c) 2008 SPF Technologie de l'Information et de la Communication/FOD Informatie- en Communicatietechnologie.  
*****************************************************************************/
...
enum BEID_Param
{
	...
	BEID_PARAM_GUITOOL_SHOWPIC,			//number; 0=no, 1=yes(default)
