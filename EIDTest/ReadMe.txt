...
========================================================================
    APPLICATION WIN32&nbsp;: Vue d'ensemble du projet EIDCardLibraryTest
========================================================================

AppWizard a cr&eacute;&eacute; cette application EIDCardLibraryTest pour vous.

Ce fichier contient un r&eacute;sum&eacute; des &eacute;l&eacute;ments contenus dans chaque fichier qui
constitue votre application EIDCardLibraryTest.


EIDCardLibraryTest.vcproj
...
EIDCardLibraryTest.ico
    Il s'agit d'un fichier ic&ocirc;ne, qui est utilis&eacute; comme ic&ocirc;ne de l'application (32x32).
    Cette ic&ocirc;ne est incluse par le fichier de ressources principal EIDCardLibraryTest.rc.
...
small.ico
    ...
    principal EIDCardLibraryTest.rc.
...
StdAfx.h, StdAfx.cpp
    ...
    nomm&eacute; EIDCardLibraryTest.pch et un fichier de types pr&eacute;compil&eacute;s nomm&eacute; StdAfx.obj.
